    ...
    <div class="obs-survey-card">
        ...
        <div class="obs-progress-bar-wrapper">
            <div class="obs-progress-meta">
                <span class="obs-step-title-display">Paso 1 de 6: Lugar de Diagnóstico y Derivación</span>
            ...
            <div class="obs-step-pills">
                <button type="button" class="obs-step-pill active" data-step="1" title="Lugar de Diagnóstico">1</button>
                <button type="button" class="obs-step-pill" data-step="2" title="Señal y Primera Atención">2</button>
                <button type="button" class="obs-step-pill" data-step="3" title="Exámenes y Derivación">3</button>
                <button type="button" class="obs-step-pill" data-step="4" title="Biopsia y Estadio">4</button>
                <button type="button" class="obs-step-pill" data-step="5" title="Tratamiento y Recorrido">5</button>
                <button type="button" class="obs-step-pill" data-step="6" title="Antecedentes y Consentimiento">6</button>
            </div>
        </div>
        ...
        <form id="obs-survey-form" novalidate>
            ...
            <!-- ========================================================== -->
            <!-- PASO 1: A. LUGAR DE DIAGNÓSTICO Y DERIVACIÓN              -->
            <!-- ========================================================== -->
            ...
            <!-- ========================================================== -->
            <!-- PASO 2: B. APARECE UNA SEÑAL & C. PRIMERA ATENCIÓN        -->
            <!-- ========================================================== -->
            ...
            <!-- ========================================================== -->
            <!-- PASO 3: D. EXÁMENES & E. DERIVACIÓN                       -->
            <!-- ========================================================== -->
            ...
            <!-- ========================================================== -->
            <!-- PASO 4: F. BIOPSIA, G. SUBTIPO & H. ESTADIO               -->
            <!-- ========================================================== -->
            ...
            <!-- ========================================================== -->
            <!-- PASO 5: I. TRATAMIENTO & J. EXPERIENCIA FINAL             -->
            <!-- ========================================================== -->
            <div class="obs-wizard-step" data-step="5">
                <div class="obs-step-heading">
                    <h3>I. INICIO DEL TRATAMIENTO Y J. EXPERIENCIA FINAL</h3>
                    <p class="obs-step-subinfo">Terapias aplicadas, barreras en el sistema y tiempos totales.</p>
                </div>
            ...
            <!-- ========================================================== -->
            <!-- PASO 6: ANTECEDENTES, CONTACTO Y CONSENTIMIENTO           -->
            <!-- ========================================================== -->
            <div class="obs-wizard-step" data-step="6">
                <div class="obs-step-heading">
                    <h3>SECCIÓN 6: ANTECEDENTES Y DATOS DE CONTACTO</h3>
                    <p class="obs-step-subinfo">Datos generales de la participante, perfil de atención y autorización final.</p>
                </div>
